  ...
  slides: [
    {
      images: [
        ...
        },
        {
          ...
          path: "/thumb3.jpg",
          link: "http://example.com",
          text: "Emotion AI provides actionable insights into business reviews using advanced AI technology. By analyzing customer feedback and reviews, Emotion AI helps businesses understand customer sentiments and identify areas for improvement."
        },
        {
          title: "title",
          path: "/thumb4.jpg",
          link: "http://example.com",
          text: "Pakistan Law AI leverages the power of LangChain to provide accurate and timely answers related to Pakistani law. This AI-driven platform offers legal professionals, students, and the general public an easy way to access legal information."
        },
      ],
    },
  ],
